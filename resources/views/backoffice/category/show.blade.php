...
@section('content')
    @section('breadcrumb-items')
        <a href="{{ route('category.index') }}">Subgéneros</a>
        ...
        <a href="{{ route('category.show', $category) }}" class="font-semibold">Vista del subgénero</a>
    @endsection

    <div class="my-6 px-2 md:px-8 py-6 bg-white rounded-md shadow-md">
        <div class="flex justify-between">
            <h2 class="mb-5 font-titles font-semibold text-xl">{{ $books->count() }} libro(s) con el subgénero <span class="text-red-900">{{ $category->name }}</span></h2>
            <!-- Start Modal -->
                            ...
                            <div class="w-full transform transition-all md:w-2/3 lg:w-1/2" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
                                <div>
                                    <div class="p-6 rounded-t-lg text-gray-700 bg-gray-200">
                                        <h2 class="font-titles font-semibold mb-2">Edición de Subgéneros</h2>
                                        <small>Cambia los datos si deseas actualizar este subgénero</small>
                                    </div>
                ...
                <table class="min-w-full text-sm">
                    <thead>
                        <tr class="font-titles font-semibold text-gray-700 bg-gray-200 text-left">
                            ...
                            <th class="p-4 rounded-tr-sm">Publicación</th>
                        </tr>
                    </thead>
                    <tbody>
        ...
        @else
            <div class="p-2 px-4 leading-6 bg-red-200 border-red-600 text-red-600 border-l-4" role="alert">
                ...
                <p>
                    Al parecer no hay libros registrados con este subgénero.
                </p>
            </div>
        @endif
    </div>
