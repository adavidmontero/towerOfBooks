<aside class="w-full relative h-auto md:fixed md:w-72 md:top-0 md:h-full bg-white uppercase text-black text-sm font-semibold font-titles shadow-md">
    ...
    <a href="{{ route('loan.front_index') }}" class="flex px-4 py-3 text-center hover:text-red-900 hover:bg-gray-200 transition ease-in-out duration-200 border-b border-gray-200">
